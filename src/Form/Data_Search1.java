 ...
 * @author ramdanirfox
 */
public class Data_Search1 extends javax.swing.JFrame {
    private DefaultTableModel model;
    private static Statement st;
 public Form_Kehadiran fK = null;
    ...
    private void tblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMouseClicked
     int tabelKry = tbl.getSelectedRow();
        fK.idKry = tbl.getValueAt(tabelKry, 0).toString();
        fK.nmKry = tbl.getValueAt(tabelKry, 1).toString();
        fK.itemTerpilih();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Data_Search1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Data_Search1().setVisible(true);
            }
        });
    }
