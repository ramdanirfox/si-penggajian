 ...
 * @author ramdanirfox
 */
public class Data_Search_Potongan extends javax.swing.JFrame {
     ...
     * @param idKry
     */
    public Data_Search_Potongan(String tgl, String idKry) {
        initComponents();
        vTgl = tgl;
        vIdKry = idKry;
   ...
   public void getData(){
        ...
        try{
            ...
            String sql = "SELECT potonganID, jenis_potongan, tanggal, jumlah FROM potongan p LEFT JOIN karyawan k ON p.karyawanID = k.karyawanID where "+k+" like '%"+c+"%' AND DATE_FORMAT(tanggal, '%Y-%m') = DATE_FORMAT('" + vTgl + "', '%Y-%m') AND k.karyawanID = " + vIdKry;
            ResultSet res = st.executeQuery(sql);
            while(res.next()){
                Object[] obj = new Object[7];
                obj[0] = res.getString("potonganID");
                obj[1] = res.getString("jenis_potongan");
    ...
    private void initComponents() {
        ...
        lJudul.setText("Detail Potongan");
...
//        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Data_Search_Potongan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
