 ...
 * @author ramdanirfox
 */
public class Data_Search5 extends javax.swing.JFrame {
    private DefaultTableModel model;
    public Form_Tunjangan  fTunjangan = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Data_Search5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Data_Search5().setVisible(true);
            }
        });
    }
