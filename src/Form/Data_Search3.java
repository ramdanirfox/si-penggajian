 ...
 * @author ramdanirfox
 */
public class Data_Search3 extends javax.swing.JFrame {
    private DefaultTableModel model;
    public Form_Cuti  fC = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Data_Search3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Data_Search3().setVisible(true);
            }
        });
    }
