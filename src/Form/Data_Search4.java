 ...
 * @author ramdanirfox
 */
public class Data_Search4 extends javax.swing.JFrame {
    private DefaultTableModel model;
    public Form_Potongan  fPemotong = null;
    ...
    private void tblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMouseClicked
        ...
        fPemotong.idKry = tbl.getValueAt(tabelKry,0).toString();
        fPemotong.nmKry = tbl.getValueAt(tabelKry, 1).toString();
        fPemotong.itemTerpilih();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Data_Search4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Data_Search4().setVisible(true);
            }
        });
    }
